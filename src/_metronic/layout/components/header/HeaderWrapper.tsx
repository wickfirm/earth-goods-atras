...
import {PageTitle} from "../toolbar/page-title/PageTitle.tsx";
                  ...
                  >
                    ...
                    <div className='d-flex align-items-center flex-grow-1 flex-lg-grow-0'>
                      <Link to='/dashboard' className='d-lg-none'>
                        <img
                            alt='Logo'
                            src={toAbsoluteUrl('/media/logos/default-small.svg', true)}
                            className='h-30px'
                        />
                      </Link>
                    </div>
            ...
            <div className='d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15'>
              <Link to='/dashboard'>
                {config.layoutType === 'dark-header' ? (
                    <img
                        alt='Logo'
                        src={toAbsoluteUrl('/media/logos/default-dark.svg', true)}
                    ...
                    <>
                      <img
                          alt='Logo'
                          src={toAbsoluteUrl('/media/logos/default.svg', true)}
