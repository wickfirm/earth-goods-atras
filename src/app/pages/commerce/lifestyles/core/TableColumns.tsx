...
const LifestylesColumns: ReadonlyArray<Column<any>> = [
    {
        ...
        Cell: ({...props}) => (
            <Restricted to='manage-commerce'>
                <ActionsCell
                    ...
                    queryKey={QUERIES.LIFESTYLE_LIST}
                    showView={false}
                    showEdit={true}
                    title="Delete Lifestyle"
                    text={`Are you sure you want to delete the lifestyle '${props.data[props.row.index].name.en}'?`}
                />
            </Restricted>
        ),
    },
