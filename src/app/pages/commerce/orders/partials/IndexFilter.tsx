...
const OrderIndexFilter: React.FC<Props> = ({showFilter, setExportQuery}) => {
                                ...
                                enableReinitialize>
                            {
                                () => (
                                    <Form onChange={onChangeHandler} placeholder={undefined}>
                                        <Row>
                                            <Col md={4}>
                                                <WickFormLabel text="IQ Client Reference" isRequired={false}/>

                                                <Field className="form-control fs-base" type="text"
                                                       placeholder="Filter by ref" name="iq_client_reference"/>

                                                <div className="mt-1 text-danger">
                                                    <ErrorMessage name="iq_client_reference" className="mt-2"/>
                                                </div>
                                            </Col>
                                        </Row>
...
export default OrderIndexFilter;