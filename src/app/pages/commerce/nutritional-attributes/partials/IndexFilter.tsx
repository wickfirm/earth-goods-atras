...
const NutritionalAttributeIndexFilter: React.FC<Props> = ({showFilter, setExportQuery}) => {
    ...
    return (
        <Collapse in={showFilter}>
            <Row id='#nutritional-attributes-list-filter'>
                <Col>
...
export default NutritionalAttributeIndexFilter;