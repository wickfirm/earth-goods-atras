...
const FaqIndexFilter: React.FC<Props> = ({showFilter, setExportQuery}) => {
                                ...
                                enableReinitialize>
                            {
                                () => (
                                    <Form onChange={onChangeHandler} placeholder={undefined}>
                                        <Row>
                                            <Col md={4}>
                                                <WickFormLabel text="Question" isRequired={false}/>

                                                <Field className="form-control fs-base" type="text"
                                                       placeholder="Filter by question" name="question"/>

                                                <div className="mt-1 text-danger">
                                                    <ErrorMessage name="question" className="mt-2"/>
                                                </div>
                                            </Col>

                                            <Col md={4}>
                                                <WickFormLabel text="Answer" isRequired={false}/>

                                                <Field className="form-control fs-base" type="text"
                                                       placeholder="Filter by answer" name="answer"/>

                                                <div className="mt-1 text-danger">
                                                    <ErrorMessage name="answer" className="mt-2"/>
                                                </div>
                                            </Col>
                                        </Row>
