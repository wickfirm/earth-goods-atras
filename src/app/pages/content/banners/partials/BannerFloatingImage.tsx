...
const BannerFloatingImage: React.FC<Props> = ({form, setForm, formik}) => {
    ...
    return (
        <KTCard>
            <KTCardHeader text="Floating Image" className="border-0"/>
            <KTCardBody className="text-center pt-0">
                ...
                <div className="text-muted fs-7">
                    Set the banner floating image. Only *.png, *.jpg, and *.jpeg image files are accepted.
                </div>
            </KTCardBody>
        </KTCard>
    );
...
export default BannerFloatingImage;
