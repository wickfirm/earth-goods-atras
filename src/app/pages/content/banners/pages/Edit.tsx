...
import {bannerSchema, defaultFormFields, fillEditForm, FormFields} from "../core/form.ts";
import {getBanner, updateBanner} from "../../../../requests/content/Banner.ts";
...
import {createDateFromString} from "../../../../helpers/dateFormatter.ts";
...
const BannerEdit: React.FC = () => {
    ...
    useEffect(() => {
        if (id) {
            submitRequest(getBanner, [parseInt(id)], (response) => {
    ...
    useEffect(() => {
        if (banner) {
            wickApp.setPageTitle(generatePageTitle(Sections.CONTENT_PROMOTIONAL_BANNERS, PageTypes.EDIT, banner?.name.en))

            setForm(fillEditForm(banner))
        }
    ...
    const handleEdit = (values: FormFields, fns: any) => {
        if (banner) {
            submitRequest(
                ...
                (response) => {
                    wickApp.setAlert({
                        message: new AlertMessageGenerator("banner", Actions.EDIT, WickToastType.SUCCESS)
                            .message,
    ...
    return (
        <>
            ...
            <Formik initialValues={form} validationSchema={bannerSchema} onSubmit={handleEdit}
                    enableReinitialize>
                {
                    (formik) => (
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body p-12">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <DatePicker
                                                    value={form.start_date ? createDateFromString(form.start_date) : null}
                                                    name='start_date'
                                            ...
                                            <div>
                                                ...
                                                <DatePicker
                                                    value={form.end_date ? createDateFromString(form.end_date) : null}
                                                    name='end_date'
                                                    className='krys-datepicker'
                                                    oneTap={true}
                                                    block
