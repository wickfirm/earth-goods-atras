...
const NewsSection = ({pageId, sectionId}: NewsProps) => {
    ...
    const handleStore = useCallback((values: SectionFormFields, fns: any) => {
        submitRequest(
            storeSectionDatum,
            [pageId, sectionId, {...values, type: SectionTypeEnum.NEWS}],
            () => {
                wickApp.setAlert({
                    message: new AlertMessageGenerator('news section settings', Actions.EDIT, WickToastType.SUCCESS).message,
