...
const ProductsSection = ({pageId, sectionId}: ProductsProps) => {
    ...
    const handleStore = useCallback((values: SectionFormFields, fns: any) => {
        submitRequest(
            storeSectionDatum,
            [pageId, sectionId, {...values, type: SectionTypeEnum.PRODUCTS}],
            () => {
                wickApp.setAlert({
                    message: new AlertMessageGenerator('products section settings', Actions.EDIT, WickToastType.SUCCESS).message,
    ...
    return (
        <>
            <KTCard className="mb-8">
                <KTCardHeader text="Products Block"/>
