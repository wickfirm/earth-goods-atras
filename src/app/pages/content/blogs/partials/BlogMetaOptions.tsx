...
const BlogMetaOptions: React.FC<Props> = ({form, setForm, formik, languages}) => {
    return (
        <KTCard className="py-4">
            ...
            <KTCardBody className="pt-0">
                ...
                <div className="row mb-10">
                    ...
                    <div className="text-muted fs-7">Set a meta tag description to the blog for increased SEO
                        ranking.
                    </div>
                </div>
                ...
                <div className="row mb-10">
                    ...
                    <div className="text-muted fs-7">
                        Set a list of keywords that the blog is related to. Separate the keywords by adding a
...
export default BlogMetaOptions;