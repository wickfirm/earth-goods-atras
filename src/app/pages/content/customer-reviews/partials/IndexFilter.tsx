...
const CustomerReviewIndexFilter: React.FC<Props> = ({showFilter, setExportQuery}) => {
    ...
    return (
        <Collapse in={showFilter}>
            <Row id='#customer-reviews-list-filter'>
                <Col>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={4}>
                                                ...
                                                <Field className="form-control fs-base" type="number"
                                                       placeholder="Filter by rating" name="rating"/>
                                            ...
                                            <Col md={4}>
                                                ...
                                                <Field className="form-control fs-base" type="text"
                                                       placeholder="Filter by review" name="review"/>

                                                <div className="mt-1 text-danger">
                                                    <ErrorMessage name="review" className="mt-2"/>
                                                </div>
                                            </Col>
                                        </Row>
...
export default CustomerReviewIndexFilter;