...
const RecipesColumns: ReadonlyArray<Column<any>> = [
    {
        Header: (props) => <CustomHeader tableProps={props} title='Thumbnail' className='min-w-50px'/>,
        id: 'thumbnail',
        Cell: ({...props}) => <ThumbnailCell src={props.data[props.row.index].featured_image[DEFAULT_RESPONSIVE_IMAGE_SIZE]}/>,
    },
    {
    ...
    },
    {
        ...
        Cell: ({...props}) => (
            ...
            <ActionsCell
                ...
                queryKey={QUERIES.CONTENT_RECIPES_LIST}
                showView={false}
                showEdit={true}
                title="Delete Recipe"
                text={`Are you sure you want to delete the recipe '${props.data[props.row.index].title.en}'?`}
            />
            // </Restricted>
        ),
    },
