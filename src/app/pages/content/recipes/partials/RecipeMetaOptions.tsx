...
const RecipeMetaOptions: React.FC<Props> = ({form, setForm, formik, languages}) => {
    return (
        <KTCard className="py-4">
            ...
            <KTCardBody className="pt-0">
                ...
                <div className="row mb-10">
                        ...
                        <div className="col-12" key={`meta-tag-description-language-${language.id}`}>
                            <div className="mb-3">
                                ...
                                <FormControl
                                    ...
                                    className='form-control fs-base mb-2'
                                    placeholder='Enter the meta tag description'
                                    defaultValue={formik.getFieldProps('meta_tag_description').value[language.id]}
                                    onChange={(e) => {
                                        const attr = `meta_tag_description.${language.id}`
                    ...
                    <div className="text-muted fs-7">Set a meta tag description to the recipe for increased SEO
                        ranking.
                    </div>
                </div>
                ...
                <div className="row mb-10">
                    ...
                    <div className="text-muted fs-7">
                        Set a list of keywords that the recipe is related to. Separate the keywords by adding a
...
export default RecipeMetaOptions;