...
const RecipeGeneralDetails: React.FC<Props> = ({formik, language}) => {
    ...
    return (
        <>
            ...
            <div className="mb-10">
                ...
                <div className="text-muted fs-7">A recipe title is required and recommended to be unique.</div>
            </div>

            <div className="d-flex flex-column mb-4">
                <span className="fs-5 text-gray-700 fw-medium">Recipe Content</span>
                <small className="text-muted">
                    Provide detailed instructions or descriptions to help users recreate the recipe.
                </small>
            </div>
