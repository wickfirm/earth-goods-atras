...
const GetCodeSubmissionIndexFilter: React.FC<Props> = ({showFilter, setExportQuery}) => {
    ...
    return (
        <Collapse in={showFilter}>
            <Row id='#get-code-submissions-list-filter'>
                <Col>
...
export default GetCodeSubmissionIndexFilter;